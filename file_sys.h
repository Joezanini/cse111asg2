...
class inode_state {
   ...
   public:
      ...
      void change_prompt(const string&);
      inode_ptr get_root();
...
class inode {
   friend ostream& operator<<(ostream& out, inode& node);
   ...
   public:
      ...
      inode_ptr child_dir(string name);
      inode_ptr make_dir(string name);
      void set_parent(inode_ptr nparent);
      void set_root(inode_ptr new_root);
      inode_ptr make_file(string name);
      void writefile(const wordvec& route);
      file_type get_ftype();
      int size();
      wordvec get_children();
      string get_iname();
...
class directory: public base_file {
   ...
   public:
      ...
      virtual void writefile (const wordvec& newdata) override;
      virtual const wordvec& readfile() const override;
      void set_dir(string dname, inode_ptr dir);
